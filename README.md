...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Roboto&weight=700&size=40&pause=1000&color=0C577F&center=true&vCenter=true&multiline=true&width=600&height=60&lines=WELCOME+TO+ANN+BUI'S+GITHUB)](https://git.io/typing-svg) 
...
const annBui = {
  ...
  techStacks: {
    frontEnd: [HTML, CSS, SASS, Javascript, TypeScript ReactJS, Angular],
    backEnd: [Ruby, Rails, PHP, ExpressJS, NodeJS],
    database: [SQL, PostgreSQl, Git],
    tools: [Figma, Jira, Slack, G Suite, LuciChart, Asana, WordPress, gitHub, gitLab],
  },
};
```
</div>
